...
export function WaveGraphic({ className = "" }: { className?: string }) {
  return (
    <div className={`pointer-events-none absolute bottom-0 left-0 right-0 overflow-hidden leading-none z-0 ${className}`}>
      <svg
        viewBox="0 0 1200 120"
        preserveAspectRatio="none"
        className="w-full h-16 sm:h-24 opacity-60"
      >
        <defs>
        ...
        <path
          d="M0,40 C150,90 350,-20 500,45 C650,110 900,10 1200,60 L1200,120 L0,120 Z"
          fill="url(#wave-grad-1)"
        />
        <path
          d="M0,70 C200,20 450,100 700,50 C950,0 1100,80 1200,75 L1200,120 L0,120 Z"
